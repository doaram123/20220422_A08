...
select m.membernumber as "회원번호", r.trainname as "기차이름", r.trainnumber as "기차번호", s.class as "차실", r.startstaion as "출발역",
r.FINISHSTATION as "도착역", r.starttime as "출발시간", r.finishtime as "도착시간", r.person as "인원", s.seat1 || s.seat2 || s.seat3 || s.seat4 as "좌석"
from membertbl m
